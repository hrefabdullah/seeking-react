...
function Card(props) {
    return (
        <div className='text-white h-max p-4 px-10 flex justify-between items-center gap-8 m-5 rounded bg-purple-700'>
            <span className='flex flex-col text-sm items-start'>
                <h1 className='text-white text-l font-bold'>{props.cName}</h1>
